      ...
      <main>
        <div className="container">
          ...
          <div className="offer-card">
            ...
            <a
              className="cta-btn offer-cta-btn"
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackContactEvent("bonus_offer_card_cta")}
            >
              ...
              <span>קבלו את ההטבה בוואטסאפ</span>
            </a>
          </div>
          ...
          <div className="cta-section">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackContactEvent("bonus_bottom_section_cta")}
            >
