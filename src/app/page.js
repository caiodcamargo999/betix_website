      ...
      <main>
        <div className="container">
          <section className="hero">
            <div className="pill">VIP ACCESS · 30% BONUS + 20 FREE SPINS</div>
